...
export const addHook = ((entryPoint: any, hookFunction: any) =>
  purify.addHook(entryPoint, hookFunction)) as DOMPurifyI['addHook']
...
export const isValidAttribute = ((tag: any, attr: any, value: any) =>
  purify.isValidAttribute(tag, attr, value)) as DOMPurifyI['isValidAttribute']
